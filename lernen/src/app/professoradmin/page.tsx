...
import { BookPlus, Search, ChevronDown } from "lucide-react";
...
export default function ProfessorDashboard() {
  ...
  return (
    <main className="flex min-h-screen flex-col bg-black text-white">
      <nav className="border-b border-gray-800 bg-black/50 px-4 py-3">
      ...
      <div className="relative flex w-full flex-1 flex-col bg-black/[0.96] antialiased bg-grid-white/[0.02]">
        <Spotlight
                ...
                <tbody>
                  {students.map((student) => (
                    <tr key={student.id} className="border-b border-gray-800 hover:bg-gray-900/50">
                      ...
                      <td className="p-3">
                        <button className="rounded-lg border border-gray-800 px-3 py-1 text-sm hover:bg-gray-800">
                          View Details
                        </button>
                      </td>
                    </tr>
